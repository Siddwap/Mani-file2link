...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7237044615:AAH3MVAuMc5u7HrMVQSuCPnz7e3SeSAzwSc")
...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5433277341"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "manii")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002177119731"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5296610774 1232844084 5433277341 1078244835").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>ɴᴀᴍᴇ</b> : {filename}\n\n<b>✅ Main Channel ID :-</b>  <i>https://t.me/+dVA-ueiXugI4ZjI9\n\n<b>Pls join and share support 🙏</b></i>")
